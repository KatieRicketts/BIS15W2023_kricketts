...
# could also use count here, there is an error message that comes up if you don't use the .groups="keep" but it is not important for now
```
...
```
You can use c() to specify multiple variables
```{r}
penguins %>%
