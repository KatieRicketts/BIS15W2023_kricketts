...
```{r}
amniota <- readr::read_csv("/Users/katiericketts/Desktop/BIS15W2023_kricketts/lab7/homework/data/amniota.csv") 
# %>% 
#   na_if("-999")
#this can be added only once you are familiar with the data frame and know it is needed
```
...
#there are a significant number of observations with a negative body mass
```
...
```{r}
# the NAs are represented as -999.00 so you would need to exclude any entries of that value
```
