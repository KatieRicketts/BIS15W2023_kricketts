...
ui <- fluidPage(
    selectInput("x", "Select Taxon", choices = c("lake fishes", "river fishes", "marine fishes", "body_mass_g"), 
              selected = "lake fishes"),
    plotOutput("plot")
)
...
ui <- fluidPage(titlePanel("Log 10 Homerange by Taxon"),
                selectInput("x", "Select Taxon", choices=c("birds", "lake fishes", "river fishes", "marine fishes", "lizards", "mammals", "snakes", "tortoises", "turtles")),
                plotOutput("plot", width="600px", height="500px")
