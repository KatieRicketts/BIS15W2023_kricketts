...
The result is not possible to caluclate, or "not available"
NAs are values that are unavailable.
...
NAs can be removed in the same command as the calculation, which makes it easier to remove the NA without having to find it in the data
